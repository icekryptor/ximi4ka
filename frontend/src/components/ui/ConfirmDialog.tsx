...
export const ConfirmDialog = ({
  ...
  return (
    ...
    >
      ...
      {/* Dialog card */}
      <div
        className="relative bg-card rounded-[32px] shadow-2xl max-w-md w-full p-8 flex flex-col gap-6"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-4">
          {variant === 'danger' ? (
            <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-red-50 dark:bg-red-950 flex items-center justify-center">
            ...
            <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-primary-50 dark:bg-primary-950 flex items-center justify-center">
