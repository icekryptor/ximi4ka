      ...
      <div className="bg-card rounded-lg shadow-xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-brand-text-secondary mt-1">Используется для БДДС и P&L</p>
          </div>
          ...
          <div>
            <label className="flex items-center space-x-2 cursor-pointer">
              ...
              />
              <span className="text-sm font-medium text-brand-text-secondary">Активна</span>
            </label>
          </div>
