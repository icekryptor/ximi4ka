...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'link', name: 'Схема сборки', href: '/production/assembly', icon: IconAssembly },
      { type: 'link', name: 'База знаний', href: '/production/knowledge-base', icon: IconKnowledgeBase },
    ],
  },
  {
    id: 'planning',
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'link', name: 'Финансы недели', href: '/marketplace/weekly-finance', icon: IconWbFinance },
  ...
  },
  {
    ...
    label: 'Настройки',
    items: [
      { type: 'link', name: 'Интеграции (API)', href: '/settings/integrations', icon: IconIntegrations },
