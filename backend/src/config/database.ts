...
const dataSourceOptions = databaseUrl
  ? {
      ...
      synchronize: false,
      logging: isDev,
      entities: [Transaction, Counterparty, Category, Component, ComponentPart, Kit, KitComponent, Supply, SupplyItem, MarketplaceSale, SkuMapping, WbAdStat, WbAdNote, WbFinancialStat, User],
